  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-screen p-4">
      ...
      <div className="flex flex-col items-start justify-start w-full max-w-4xl h-full overflow-auto p-4 bg-white rounded shadow">
        ...
        <button onClick={() => setShowFlowChart(true)} className="px-4 py-2 text-white bg-blue-500 rounded hover:bg-blue-700">
          Click here to view the flowchart
        </button>
        {showFlowChart && (
        <div className="fixed top-0 right-0 w-1/2 h-full bg-white p-4 shadow-xl z-10 overflow-y-auto">
          <button onClick={() => setShowFlowChart(false)} className="px-4 py-2 text-white bg-red-500 rounded hover:bg-red-700">
            Close
          </button>
